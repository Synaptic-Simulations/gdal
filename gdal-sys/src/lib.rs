...
#[doc = " that can be opened along the main file. If no other file than pszFilename needs to"]
#[doc = " be opened, return static_cast<char**> (CPLCalloc(1,sizeof(char*)));"]
#[doc = ""]
#[doc = " Optional"]
#[doc = " @since GDAL 3.2"]
...
#[doc = " (rw), (r), (w) or () at the end indicate whether the given callback is mandatory"]
...
pub mod OGRwkbGeometryType {
    ...
    pub const wkbPoint25D: Type = -2147483647;
    #[doc = "< 2.5D extension as per 99-402"]
    pub const wkbLineString25D: Type = -2147483646;
    #[doc = "< 2.5D extension as per 99-402"]
    pub const wkbPolygon25D: Type = -2147483645;
    #[doc = "< 2.5D extension as per 99-402"]
    pub const wkbMultiPoint25D: Type = -2147483644;
    #[doc = "< 2.5D extension as per 99-402"]
    pub const wkbMultiLineString25D: Type = -2147483643;
    #[doc = "< 2.5D extension as per 99-402"]
    pub const wkbMultiPolygon25D: Type = -2147483642;
    #[doc = "< 2.5D extension as per 99-402"]
    pub const wkbGeometryCollection25D: Type = -2147483641;
}
extern "C" {
...
pub mod OGRFieldDomainSplitPolicy {
    ...
    #[doc = ""]
    #[doc = " When a feature is split in two, defines how the value of attributes"]
    #[doc = " following the domain are computed."]
    #[doc = ""]
    #[doc = " @since GDAL 3.3"]
    pub type Type = libc::c_int;
    #[doc = " Default value"]
...
pub mod OGRFieldDomainMergePolicy {
    ...
    #[doc = ""]
    #[doc = " When a feature is built by merging two features, defines how the value of"]
    #[doc = " attributes following the domain are computed."]
    #[doc = ""]
    #[doc = " @since GDAL 3.3"]
    pub type Type = libc::c_int;
    #[doc = " Default value"]
...
pub mod GDALRIOResampleAlg {
    ...
    #[doc = " @endcond */"]
    #[doc = " For complex numbers, applies on the real and imaginary part independently."]
    pub const GRIORA_RMS: Type = 14;
    #[doc = " @cond Doxygen_Suppress"]
    pub const GRIORA_LAST: Type = 14;
}
#[doc = " Structure to pass extra arguments to RasterIO() method,"]
#[doc = " must be initialized with INIT_RASTERIO_EXTRA_ARG"]
#[doc = " @since GDAL 2.0"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
